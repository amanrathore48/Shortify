...
const Navbar = () => {
  ...
  return (
    <div id="navbar" className="flex justify-between md:pt-5">
      <div className="flex gap-8 justify-between items-center w-full">
        <h2 className="text-3xl sm:text-4xl mr-4 font-semibold text-np">
          <a href="/">Shortify</a>
        </h2>
        ...
        <div className="hidden sm:flex items-center justify-between w-full">
          ...
          <div className="flex gap-10 items-center">
            ...
            <div>
              <button
                className="bg-[#74EE15] font-semibold text-white px-5 py-2 rounded-full hover:bg-zinc-800"
                type="button"
              >
                Sign up
              </button>
