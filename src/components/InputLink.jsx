...
const InputLink = () => {
  ...
  return (
    <form
      ...
      className="bg-zinc-800  absolute w-full sm:text-left text-center  mt-10 sm:w-full sm:flex-row flex-col left-0 -top-20 gap-5 flex px-8 py-6 sm:px-14 sm:py-10 "
    >
      ...
      <button
        type="submit"
        disabled={isLoading}
        className="bg-ng disabled:bg-zinc-600 text-center inline-flex items-center transition duration-150 ease-in-out flex-1 py-4 w-full sm:py-0 hover:bg-np text-white font-bold px-10 rounded-lg whitespace-nowrap"
      >
        {isLoading ? (
          <>
            <svg
